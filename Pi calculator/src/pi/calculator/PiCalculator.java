...
public class PiCalculator {
    ...
    public static int digits(){
        System.out.println("Pi calculator. Using the Borwein altorithm (1985). Note that last few digits are usually wrong. Verbose mode on. Copyright May 9, 2012 Leif Jurvetson.");
